...
Namespace Deserialiser
    ...
    Partial Public Class lexdef
        
        Private recordtypesField() As lexdefRecord
        
        Private assembliesField() As lexdefAssembly
        ...
        Public Property recordtypes() As lexdefRecord()
            Get
        ...
        Public Property assemblies() As lexdefAssembly()
            Get
    ...
    Partial Public Class lexdefAssembly
        ...
        Private propertyField() As lexdefAssemblyProperty
        
        Private nameField As String
        
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("property")>  _
        Public Property [property]() As lexdefAssemblyProperty()
            Get
